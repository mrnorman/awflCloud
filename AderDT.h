...
public:
  ...
  inline _HOSTDEV void diffTransformEulerX( SArray<real,numState,tord,tord> &state, SArray<real,numState,tord,tord> &flux, SArray<real,tord,tord> &deriv ) {
  ...
  inline _HOSTDEV void diffTransformEulerY( SArray<real,numState,tord,tord> &state, SArray<real,numState,tord,tord> &flux, SArray<real,tord,tord> &deriv ) {
  ...
  inline _HOSTDEV void diffTransformEulerZ( SArray<real,numState,tord,tord> &state, SArray<real,numState,tord,tord> &flux,
                                   SArray<real,tord,tord> &source, SArray<real,tord,tord> &deriv, SArray<real,tord> &hyRHOT, SArray<real,tord> &hyRHO ) {
